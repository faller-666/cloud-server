...
import com.cloudstorage.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    // 将 RolesInterceptor 注册为安全过滤器链所需的 MVC 拦截器由 WebMvcConfig 完成
    @Bean
    public RolesInterceptor rolesInterceptorBean() {
        return rolesInterceptor;
    }
}